...
author: Ralph Mul
date: 14-08-2020
file: adspy_shared_utilities.py
version: 0.1
description: this code is downloaded from https://notebooks.azure.com/SaschaFischer/projects/pruefung/html/adspy_shared_utilities.py
"""
...
def plot_fruit_knn(X, y, n_neighbors, weights):
    ...
    """
    adspy_shared_utilities.py:207: MatplotlibDeprecationWarning: shading='flat' when X and Y have the same dimensions as C is deprecated since 3.3.  Either specify the corners of the quadrilaterals with X and Y, or pass shading='auto', 'nearest' or 'gouraud', or set rcParams['pcolor.shading'].  This will become an error two minor releases later.
